...
from nominal_code.commands.webhook.result import DispatchResult, DispatchStatus
...
from nominal_code.models import COMMENT_EVENT_TYPES
...
if TYPE_CHECKING:
    from nominal_code.commands.webhook.jobs.runner.base import JobRunner
