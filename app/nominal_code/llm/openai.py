...
def _map_tool_choice(tool_choice: ToolChoice) -> OpenAIToolChoice:
    """
    Map a canonical ``ToolChoice`` to the OpenAI API literal.

    Args:
        tool_choice (ToolChoice): The canonical tool choice.

    Returns:
        OpenAIToolChoice: The OpenAI API tool_choice value.
    """

    return TOOL_CHOICE_MAP[tool_choice]
