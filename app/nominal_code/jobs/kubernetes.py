...
class KubernetesRunner:
    ...
    Uses ``httpx.AsyncClient`` with in-cluster auth to create Jobs via
    the Kubernetes API. No external dependencies beyond httpx.
    ...
    async def run(self, job: ReviewJob) -> None:
        ...
        Args:
            job (ReviewJob): The review job to dispatch.
        """
    ...
    def _build_job_spec(
        ...
        Args:
            ...
            payload (str): Serialized ReviewJob JSON.
            job (ReviewJob): The review job for label metadata.
