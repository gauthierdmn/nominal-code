...
from nominal_code.commands.webhook.jobs.queue.redis import RedisJobQueue
...
class TestKubernetesRunnerExecute:
    ...
    async def test_create_and_await_success(self):
        ...
        with (
            patch(
                "nominal_code.commands.webhook.jobs.runner.kubernetes._read_service_account_token",
                return_value="test-token",
            ),
            patch(
                "nominal_code.commands.webhook.jobs.runner.kubernetes.httpx.AsyncClient",
